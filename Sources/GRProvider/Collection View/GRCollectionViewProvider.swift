...
open class GRCollectionViewProvider<Section: Sectionable>:
    ...
    /// Closure calls when `collectionView should deselect same item in multiselect mode` fires up.
    open var configureShouldDeselectItem: ItemSelectionStateApprovalProvider? = nil

    /// Closure calls when `collectionView should select item` fires up.
    open var configureShouldSelectItem: ItemSelectionStateApprovalProvider? = nil
    ...
    open func collectionView(
        ...
        return configureShouldDeselectItem?(self, collectionView, indexPath, section) ?? true
    }
    ...
    open func collectionView(
        ...
        let section = sections[indexPath.section]
        return configureShouldSelectItem?(self, collectionView, indexPath, section) ?? true
    }
    ...
    open func collectionView(
        ...
        return configureSectionInsets?(
            self,
            collectionView,
            sections[section]) ?? sectionInsets ?? UIEdgeInsets.zero
    }
    ...
    open func collectionView(
        ...
        return configureCellSize?(
            self,
            collectionView,
            indexPath, sections[indexPath]) ?? cellSize ?? .zero
    }
    ...
    open func collectionView(
        ...
        return configureMinLineSpacingForSection?(
            self,
            collectionView,
            sections[section]) ?? minimumLineSpacingForSection ?? 0
    }
    ...
    open func collectionView(
        ...
        return configureMinInteritemSpacingForSection?(
            self,
            collectionView,
            sections[section]) ?? minInteritemSpacingForSection ?? 0
    }
