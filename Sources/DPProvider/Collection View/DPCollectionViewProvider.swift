...
open class DPCollectionViewProvider<Section: Sectionable>: NSObject, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    
    public typealias ItemProvider = (DPCollectionViewProvider, UICollectionView, IndexPath, Section.Item) -> UICollectionViewCell
    public typealias ItemSizeProvider = (DPCollectionViewProvider, UICollectionView, IndexPath, Section.Item) -> CGSize
    public typealias SupplementaryViewProvider = (DPCollectionViewProvider, UICollectionView, IndexPath, String) -> UICollectionReusableView
    public typealias SwipeGestureProvider = (DPCollectionViewProvider, UICollectionView, IndexPath, Section.Item) -> ([UIContextualAction])
    public typealias SectionInsetProvider = (DPCollectionViewProvider, UICollectionView, Section) -> UIEdgeInsets
    public typealias ItemSelectionProvider = (DPCollectionViewProvider, UICollectionView, Section.Item) -> ()
    public typealias MinLineSpacingProvider = (DPCollectionViewProvider, UICollectionView, Section) -> CGFloat
