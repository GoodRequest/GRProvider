//
//  DPDeepDiffCollectionViewProvider.swift
//  Sample
//
...
final public class DPDeepDiffCollectionViewProvider<Section: Sectionable & DiffAware>: DPCollectionViewProvider<Section> where
