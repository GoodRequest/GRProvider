...
import XCTest
@testable import DPProvider
@testable import DeepDiff

class DPProviderTests: XCTestCase {
    ...
    func testBindingToSimpleProviderWithOneSection() throws {
        ...
        let provider = DPSimpleTableViewProvider<String>()
    ...
    func testBindingToTableProviderWithOneSection() throws {
        ...
        let tableView = UITableView()
        let provider = DPTableViewProvider<Section>()
